...
router.get('/users/:user_id', verifyToken, authorizeRoles("superAdmin", "admin", "user"), firstLogin, userController.fetchUserById);
router.patch('/users/:user_id', verifyToken, authorizeRoles("superAdmin", "admin", "user"), firstLogin, userController.updateUserById);
