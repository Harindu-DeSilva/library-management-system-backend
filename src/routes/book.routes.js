...
router.get('/books', verifyToken, authorizeRoles("superAdmin", "admin", "user"),firstLogin, bookController.fetchAllBooks);
router.get('/books/:category_id', verifyToken, authorizeRoles("superAdmin", "admin", "user"),firstLogin, bookController.fetchAllBooksByCategoryID);
router.get('/books/:book_id/book', verifyToken, authorizeRoles("superAdmin", "admin", "user"),firstLogin, bookController.fetchBookByID);
